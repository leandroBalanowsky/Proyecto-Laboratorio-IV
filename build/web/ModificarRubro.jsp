...
<html>
    <head>
        ...
        <title>ComerBook - Modificar Rubro</title>
    </head>
    <body>
        <%--Encabezado --%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="card my-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/Parcial2/ModificarRubro">
                                    <div class="form-group">
                                        <label for="txtRubro">Rubro</label>
                                        <input type="hidden" name="txtIdRubro" value="${rubro.idRubro}">
                                        <input type="text" name="txtRubro" class="form-control" id="txtRubro"  value="${rubro.rubro}" aria-describedby="ayudaRubro" maxlength="100">
                                        <small id="ayudaRubro" class="form-text text-muted">por ejemplo: gastronomía, almacén, cuidado personal, etc.</small>
                                    </div>
                                    <button type="submit" class="btn btn-success" value="Grabar" onclick="return validarRubro();">Cargar</button>
