 ...
 * @author aelde
 */
@WebServlet(name = "InsertarComercio", urlPatterns = {"/InsertarComercio"})
@MultipartConfig(
...
public class InsertarComercio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertarComercio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertarComercio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for(Part part:  request.getParts()) {
            ...
            if (!fileName.isEmpty()){
                ...
                imgComercio = "default.jpg";
            }
                
        }
        g.insertarComercio(new Comercio(nombre, descripcion, direccion, rubro, imgComercio));
